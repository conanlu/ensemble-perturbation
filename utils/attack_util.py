...
left_eye_idx = list(range(37 - 1, 42))
right_eye_idx = list(range(43 - 1, 48))
mouth_idx = list(range(49 - 1, 68))
nose_idx = list(range(28 - 1, 36))
jaw_idx = list(range(1 - 1, 17))
left_eyebrow_idx = list(range(18 - 1, 22))
right_eyebrow_idx = list(range(23 - 1, 27))
